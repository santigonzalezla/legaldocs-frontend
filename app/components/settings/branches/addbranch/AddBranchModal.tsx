...
const AddBranchModal = ({open, saving, name, desc, color, onClose, onSave, onName, onDesc, onColor}: AddBranchModalProps) =>
{
    if (!open) return null;
        ...
        <div className={styles.overlay} onClick={onClose}>
            <div className={styles.modal} onClick={e => e.stopPropagation()}>
                ...
                <div className={styles.formGroup}>
                    ...
                    />
                    {name && (
                        <span className={styles.slugPreview}>slug: {toSlug(name)}</span>
                    )}
                </div>
                ...
                <div className={styles.modalActions}>
                    ...
                    <button
                        ...
                        type="button"
                    >
                        {saving ? 'Guardando...' : <><Plus /> Crear Rama</>}
                    </button>
                </div>
            </div>
        </div>
